...
VALUES
('Admin User', 'admin@clinic.com', '$2y$12$FEmXnRGevsgKenC.iPdEQemJc2S4H4nCYth50jcRl6ZP8qEQXsv9m', 'admin'),
('Reception Staff', 'reception@clinic.com', '$2y$12$FEmXnRGevsgKenC.iPdEQemJc2S4H4nCYth50jcRl6ZP8qEQXsv9m', 'staff')
ON DUPLICATE KEY UPDATE password_hash = VALUES(password_hash);

INSERT IGNORE INTO patients (name, email, phone, gender)
VALUES
...
INSERT IGNORE INTO appointments (appointment_code, patient_name, patient_email, appointment_date, status, note)
VALUES
...
('APT-2026-0018', 'Nguyen Van S', 'nguyens@example.com', '2026-07-03', 'confirmed', 'Kham da lieu'),
('APT-2026-0019', 'Tran Thi T', 'tranthit@example.com', '2026-07-04', 'pending', 'Kham tai mui hong'),
('APT-2026-0020', 'Vo Thi F', 'vothif@example.com', '2026-07-04', 'completed', 'Tai kham');
